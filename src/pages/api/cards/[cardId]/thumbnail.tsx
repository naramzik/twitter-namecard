            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25em' }}>
              ...
              {(foundCard.socialMedia as CardType['socialMedia'])?.github && (
                <div style={{ display: 'flex', gap: '0.5em' }}>
                  ...
                  <span style={{ width: '140px' }}>@{(foundCard.socialMedia as CardType['socialMedia'])?.github}</span>
                </div>
              )}
              {(foundCard.socialMedia as CardType['socialMedia'])?.blog && (
                <div style={{ display: 'flex', gap: '0.5em' }}>
                  ...
                  <span style={{ width: '140px' }}>{(foundCard.socialMedia as CardType['socialMedia'])?.blog}</span>
                </div>
              )}
            </div>
          </div>
