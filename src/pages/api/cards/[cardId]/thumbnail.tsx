        ...
        >
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '2.5em', lineHeight: 1, fontWeight: 'bold' }}>Elon Musk</span>
              <span style={{ fontSize: '1.5em', lineHeight: 1 }}>@elonmusk</span>
              <span style={{ fontSize: '1em', marginTop: '0.5em' }}>"안녕하세요 저는 일론 머스크입니다 하핫!"</span>
            </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25em' }}>
              <div style={{ display: 'flex', gap: '0.5em' }}>
                ...
                <span style={{ width: '140px' }}>@instagram</span>
              </div>
              <div style={{ display: 'flex', gap: '0.5em' }}>
                ...
                <span style={{ width: '140px' }}>@Githunbnnnnnnn</span>
              </div>
              <div style={{ display: 'flex', gap: '0.5em' }}>
                ...
                <span style={{ width: '140px' }}>https://nabi-blog.vercel.app/</span>
              </div>
            </div>
          </div>
        </div>
