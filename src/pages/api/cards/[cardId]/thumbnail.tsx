        ...
        >
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '2.5em', lineHeight: 1, fontWeight: 'bold' }}>{foundCard.nickname}</span>
              <span style={{ fontSize: '1.5em', lineHeight: 1 }}>@{foundCard.twitter ?? 'anonymous'}</span>
              {foundCard.bio && <span style={{ fontSize: '1em', marginTop: '0.5em' }}>"{foundCard.bio}"</span>}
            </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25em' }}>
              {foundCard.socialMedia.instagram && (
                <div style={{ display: 'flex', gap: '0.5em' }}>
                  ...
                  <span style={{ width: '140px' }}>@{foundCard.socialMedia.instagram}</span>
                </div>
              )}
              {foundCard.socialMedia.github && (
                <div style={{ display: 'flex', gap: '0.5em' }}>
                  ...
                  <span style={{ width: '140px' }}>@{foundCard.socialMedia.github}</span>
                </div>
              )}
              {foundCard.socialMedia.blog && (
                <div style={{ display: 'flex', gap: '0.5em' }}>
                  ...
                  <span style={{ width: '140px' }}>{foundCard.socialMedia.blog}</span>
                </div>
              )}
            </div>
          </div>
