  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25em', fontSize: '0.5em' }}>
          {githubId && (
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5em' }}>
              ...
              <span style={{ width: '100px', wordBreak: 'break-all' }}>@{githubId}</span>
            </div>
          )}
          {instagramId && (
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5em' }}>
              ...
              <span style={{ width: '100px', wordBreak: 'break-all' }}>@{instagramId}</span>
            </div>
          )}
          {blog && (
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5em' }}>
              ...
              <span style={{ width: '100px', wordBreak: 'break-all' }}>{blog}</span>
            </div>
          )}
        </div>
      </div>
